...
export function CyberpunkPanel({
  ...
  return (
    <section
      ...
      `}
    >
      <div className="relative h-full rounded-[calc(1.5rem-2px)] bg-[rgba(10,0,6,0.35)] backdrop-blur-xl px-5 py-5 sm:px-6 sm:py-6">
        {/* HUD grid */}
        ...
        <header className="relative mb-5 flex items-center justify-between border-b border-white/10 pb-4">
          <div>
            <p className="font-heading text-xs uppercase tracking-[0.35em] text-[#b0906b]/80 neon-text-yellow">
              Module
            </p>
            <h2 className="font-heading text-3xl uppercase tracking-[0.25em] text-[#f7e6cf] neon-text-amber">
              {title}
            </h2>
          </div>
          <div className="flex items-center gap-2 text-[0.65rem] uppercase tracking-[0.35em] text-[#b0906b]/80">
